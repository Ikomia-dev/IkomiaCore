...
BOOST_PYTHON_MODULE(pycore)
{
    ...
    class_<CWorkflowTaskWrap, std::shared_ptr<CWorkflowTaskWrap>>("CWorkflowTask", _WorkflowTaskDocString)
        ...
        .def("emit_parameters_modified", &CWorkflowTaskWrap::emitParametersModified, _emitParametersModifiedDocString, args("self"))
    ...
    class_<CWorkflowTaskWidgetWrap, std::shared_ptr<CWorkflowTaskWidgetWrap>, boost::noncopyable>("CWorkflowTaskWidget", _WorkflowTaskWidget)
        ...
        .def("on_parameters_modified", &CWorkflowTaskWidget::onParametersModified, &CWorkflowTaskWidgetWrap::default_onParametersModified, _onParamsModifiedDocString, args("self"))

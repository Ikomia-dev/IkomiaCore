...
BOOST_PYTHON_MODULE(pycore)
{
    ...
    class_<CWorkflowTaskIOWrap, std::shared_ptr<CWorkflowTaskIOWrap>>("CWorkflowTaskIO", _WorkflowTaskIODocString)
        ...
        .def("is_auto_input", &CWorkflowTaskIO::isAutoInput, &CWorkflowTaskIOWrap::default_isAutoInput, _isAutoInputDocString, args("self"))
    ...
    class_<CWorkflowTaskWrap, std::shared_ptr<CWorkflowTaskWrap>>("CWorkflowTask", _WorkflowTaskDocString)
        ...
        .def("set_input", &CWorkflowTask::setInput, &CWorkflowTaskWrap::default_setInput, _setInputDocString, args("self", "input", "index", "is_new_sequence"))
        .def("set_inputs", &CWorkflowTask::setInputs, &CWorkflowTaskWrap::default_setInputs, _setInputsDocString, args("self", "inputs", "is_new_sequence"))

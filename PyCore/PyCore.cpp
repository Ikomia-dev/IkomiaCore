...
BOOST_PYTHON_MODULE(pycore)
{
    ...
    class_<CWorkflowTaskParamWrap, std::shared_ptr<CWorkflowTaskParamWrap>>("CWorkflowTaskParam", _WorkflowTaskParamDocString)
        ...
        .def("set_values", &CWorkflowTaskParamWrap::setParamMap, &CWorkflowTaskParamWrap::default_setParamMap, _setParamMapDocString, args("self", "params"))
        .def("get_values", &CWorkflowTaskParamWrap::getParamMap, &CWorkflowTaskParamWrap::default_getParamMap, _getParamMapDocString, args("self"))
        .def("get_hash_value", &CWorkflowTaskParamWrap::getHashValue, &CWorkflowTaskParamWrap::default_getHashValue, _getHashValueDocString, args("self"))
    ;
    ...
    std::string (CWorkflowTaskIOWrap::*toJsonNoOpt)() const = &CWorkflowTaskIOWrap::toJson;
    std::string (CWorkflowTaskIOWrap::*toJson)(const std::vector<std::string>&) const = &CWorkflowTaskIOWrap::toJson;
    ...
    class_<CWorkflowTaskIOWrap, std::shared_ptr<CWorkflowTaskIOWrap>>("CWorkflowTaskIO", _WorkflowTaskIODocString)
        ...
        .def(self_ns::str(self_ns::self))
        .def("get_unit_element_count", &CWorkflowTaskIOWrap::getUnitElementCount, &CWorkflowTaskIOWrap::default_getUnitElementCount, _getUnitElementCountDocString, args("self"))
        .def("is_data_available", &CWorkflowTaskIOWrap::isDataAvailable, &CWorkflowTaskIOWrap::default_isDataAvailable, _isDataAvailableDocString, args("self"))
        .def("is_auto_input", &CWorkflowTaskIOWrap::isAutoInput, &CWorkflowTaskIOWrap::default_isAutoInput, _isAutoInputDocString, args("self"))
        .def("is_composite", &CWorkflowTaskIOWrap::isComposite, &CWorkflowTaskIOWrap::default_isComposite, _isCompositeDocString, args("self"))
        .def("clear_data", &CWorkflowTaskIOWrap::clearData, &CWorkflowTaskIOWrap::default_clearData, _clearDataDocString, args("self"))
        .def("copy_static_data", &CWorkflowTaskIOWrap::copyStaticData, &CWorkflowTaskIOWrap::default_copyStaticData, _copyStaticDataDocString, args("self", "io"))
        .def("load", &CWorkflowTaskIOWrap::load, &CWorkflowTaskIOWrap::default_load, _loadDocString, args("self", "path"))
        ...
        .def("from_json", &CWorkflowTaskIOWrap::fromJson, &CWorkflowTaskIOWrap::default_fromJson, _fromJsonDocString, args("self", "jsonStr"))
    ;
    ...
    class_<CWorkflowTaskWrap, std::shared_ptr<CWorkflowTaskWrap>>("CWorkflowTask", _WorkflowTaskDocString)
        ...
        .def("set_input_data_type", &CWorkflowTaskWrap::setInputDataType, &CWorkflowTaskWrap::default_setInputDataType, _setInputDataTypeDocString, args("self", "data_type", "index"))
        .def("set_input", &CWorkflowTaskWrap::setInput, &CWorkflowTaskWrap::default_setInput, _setInputDocString, args("self", "input", "index", "is_new_sequence"))
        .def("set_inputs", &CWorkflowTaskWrap::setInputs, &CWorkflowTaskWrap::default_setInputs, _setInputsDocString, args("self", "inputs", "is_new_sequence"))
        .def("set_output_data_type", &CWorkflowTaskWrap::setOutputDataType, &CWorkflowTaskWrap::default_setOutputDataType, _setOutputDataTypeDocString, args("self", "data_type", "index"))
        .def("set_output", &CWorkflowTaskWrap::setOutput, &CWorkflowTaskWrap::default_setOutput, _setOutputDocString, args("self", "output", "index"))
        .def("set_outputs", &CWorkflowTaskWrap::setOutputs, &CWorkflowTaskWrap::default_setOutputs, _setOutputsDocString, args("self", "outputs"))
        ...
        .def("set_active", &CWorkflowTaskWrap::setActive, &CWorkflowTaskWrap::default_setActive, _setActiveDocString, args("self", "is_active"))
        ...
        .def("get_progress_steps", &CWorkflowTaskWrap::getProgressSteps, &CWorkflowTaskWrap::default_getProgressSteps, _getProgressStepsDocString, args("self"))
        .def("is_graphics_changed_listening", &CWorkflowTaskWrap::isGraphicsChangedListening, &CWorkflowTaskWrap::default_isGraphicsChangedListening, _isGraphicsChangedListeningDocString, args("self"))
        ...
        .def("stop", &CWorkflowTaskWrap::stop, &CWorkflowTaskWrap::default_stop, _stopDocString, args("self"))
        .def("execute_actions", &CWorkflowTaskWrap::executeActions, &CWorkflowTaskWrap::default_executeActions, _executeActionsDocString, args("self", "action"))
        .def("update_static_outputs", &CWorkflowTaskWrap::updateStaticOutputs, &CWorkflowTaskWrap::default_updateStaticOutputs, _updateStaticOutputsDocString, args("self"))
        .def("begin_task_run", &CWorkflowTaskWrap::beginTaskRun, &CWorkflowTaskWrap::default_beginTaskRun, _beginTaskRunDocString, args("self"))
        .def("end_task_run", &CWorkflowTask::endTaskRun, &CWorkflowTaskWrap::default_endTaskRun, _endTaskRunDocString, args("self"))
        .def("parameters_modified", &CWorkflowTaskWrap::parametersModified, &CWorkflowTaskWrap::default_parametersModified, _parametersModifiedDocString, args("self"))
        .def("graphics_changed", &CWorkflowTaskWrap::graphicsChanged, &CWorkflowTaskWrap::default_graphicsChanged, _graphicsChangedDocString, args("self"))
        .def("global_input_changed", &CWorkflowTaskWrap::globalInputChanged, &CWorkflowTaskWrap::default_globalInputChanged, _globalInputChangedDocString, args("self", "is_new_sequence"))
        ...
        .def("workflow_started", &CWorkflowTaskWrap::workflowStarted, &CWorkflowTaskWrap::default_workflowStarted, _workflowStartedDocString, args("self"))
        .def("workflow_finished", &CWorkflowTaskWrap::workflowFinished, &CWorkflowTaskWrap::default_workflowFinished, _workflowStartedDocString, args("self"))

...
BOOST_PYTHON_MODULE(pydataprocess)
{
    ...
    class_<C2dImageTaskWrap, bases<CWorkflowTask>, std::shared_ptr<C2dImageTaskWrap>>("C2dImageTask", _imageProcess2dDocString)
        ...
        .def("createInputGraphicsMask", &C2dImageTask::createInputGraphicsMask, _createInputGraphicsMaskDocString, args("self", "index", "width", "height"))
        .def("createGraphicsMask", &C2dImageTask::createGraphicsMask, _createGraphicsMaskDocString, args("self", "width", "height", "graphics"))
        .def("applyGraphicsMask", &C2dImageTaskWrap::applyGraphicsMask, _applyGraphicsMaskDocString, args("self", "src", "dst", "index"))
        .def("applyGraphicsMaskToBinary", &C2dImageTaskWrap::applyGraphicsMaskToBinary, _applyGraphicsMaskToBinaryDocString, args("self", "src", "dst", "index"))

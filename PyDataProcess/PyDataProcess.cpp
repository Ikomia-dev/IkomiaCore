...
BOOST_PYTHON_MODULE(pydataprocess)
{
    ...
    class_<CTextStreamIOWrap, bases<CWorkflowTaskIO>, std::shared_ptr<CTextStreamIOWrap>, boost::noncopyable>("CTextStreamIO", _textStreamDocString)
        ...
        .def("read_next", &CTextStreamIOWrap::readNext, _textStreamReadNextDocString, args("self", "timeout"))
        ...
        .def("shutdown", &CTextStreamIOWrap::shutdown, _textStreamShutdownDocString, args("self"))
    ...
    class_<C2dImageTaskWrap, bases<CWorkflowTask>, std::shared_ptr<C2dImageTaskWrap>>("C2dImageTask", _imageProcess2dDocString)
        ...
        .def("init_long_process", &C2dImageTask::initLongProcess, &C2dImageTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CVideoTaskWrap, bases<C2dImageTask>, std::shared_ptr<CVideoTaskWrap>>("CVideoTask", _videoProcessDocString)
        ...
        .def("init_long_process", &CVideoTask::initLongProcess, &CVideoTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CClassifTaskWrap, bases<C2dImageTask>, std::shared_ptr<CClassifTaskWrap>>("CClassificationTask", _classifTaskDocString)
        ...
        .def("init_long_process", &CClassificationTask::initLongProcess, &CClassifTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CObjDetectTaskWrap, bases<C2dImageTask>, std::shared_ptr<CObjDetectTaskWrap>>("CObjectDetectionTask", _objDetTaskDocString)
        ...
        .def("init_long_process", &CObjectDetectionTask::initLongProcess, &CObjDetectTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CSemanticSegTaskWrap, bases<C2dImageTask>, std::shared_ptr<CSemanticSegTaskWrap>>("CSemanticSegmentationTask", _semSegTaskDocString)
        ...
        .def("init_long_process", &CSemanticSegTask::initLongProcess, &CSemanticSegTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CInstanceSegTaskWrap, bases<C2dImageTask>, std::shared_ptr<CInstanceSegTaskWrap>>("CInstanceSegmentationTask", _instanceSegTaskDocString)
        ...
        .def("init_long_process", &CInstanceSegTask::initLongProcess, &CInstanceSegTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CKeyptsDetectTaskWrap, bases<C2dImageTask>, std::shared_ptr<CKeyptsDetectTaskWrap>>("CKeypointDetectionTask", _keyDetTaskDocString)
        ...
        .def("init_long_process", &CKeypointDetectionTask::initLongProcess, &CKeyptsDetectTaskWrap::default_initLongProcess, _initLongProcessDocString, args("self"))
    ...
    class_<CWorkflowWrap, bases<CWorkflowTask>, std::shared_ptr<CWorkflowWrap>>("CWorkflow", _workflowDocString)
        ...
        .add_property("type", &CWorkflowWrap::getType, &CWorkflowWrap::setType, "Main purpose or data type on which the workflow is dedicated to.")

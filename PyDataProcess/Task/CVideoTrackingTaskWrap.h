...
#ifndef CVIDEOTRACKINGTASKWRAP_H
...
//----------------------------------------------------------//
class CVideoTrackingTaskWrap : public CVideoTrackingTask, public wrapper<CVideoTrackingTask>
{
    public:

        CVideoTrackingTaskWrap();
        CVideoTrackingTaskWrap(const std::string& name);
        CVideoTrackingTaskWrap(const CVideoTrackingTask &process);

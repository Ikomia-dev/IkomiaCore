...
void CProxyGraphicsEllipse::insertToImage(CMat &image, CGraphicsConversion &filler, bool bForceFill, bool bBinary, bool bgr) const
{
...
void CProxyGraphicsEllipse::fromJson(const QJsonObject &obj)
{
...
void CGraphicsEllipse::buildFromJsonData(CGraphicsJSON &jsonMgr, QByteArray data)
{
    ...
    catch (const CException&)
    {
        ...
        Utils::print("Unable to load JSON binary Data, ellipse can't be created.", QtMsgType::QtWarningMsg);
    }
}

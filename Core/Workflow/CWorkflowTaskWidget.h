...
#ifndef CWORKFLOWTASKWIDGET_H
#define CWORKFLOWTASKWIDGET_H
...
/**
 * @ingroup groupCore
 * @brief The CWorkflowTaskWidget class must be the base class for all widget class associated with a process task.
...
class CORESHARED_EXPORT CWorkflowTaskWidget : public QWidget
{
    ...
    public:
        ...
        */
        CWorkflowTaskWidget(QWidget *parent = Q_NULLPTR);
        virtual ~CWorkflowTaskWidget() = default;
    ...
    public slots:
        ...
        virtual void    onParametersModified();
    ...
    signals:
         ...
         * @param pParam: CWorkflowTaskParam base shared pointer.
         */
        void            doApplyProcess(const WorkflowTaskParamPtr& pParam);
        /**
...
using WorkflowTaskWidgetUPtr = std::unique_ptr<CWorkflowTaskWidget>;

#endif // CWORKFLOWTASKWIDGET_H

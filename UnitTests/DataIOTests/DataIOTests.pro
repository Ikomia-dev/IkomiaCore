...
#Dynamic link OpenCV
win32:CONFIG(release, debug|release):LIBS += -lopencv_core$${OPENCV_VERSION} -lopencv_highgui$${OPENCV_VERSION} -lopencv_imgproc$${OPENCV_VERSION} -lopencv_imgcodecs$${OPENCV_VERSION}
win32:CONFIG(debug, debug|release):LIBS += -lopencv_core$${OPENCV_VERSION}d -lopencv_highgui$${OPENCV_VERSION}d -lopencv_imgproc$${OPENCV_VERSION}d -lopencv_imgcodecs$${OPENCV_VERSION}d
unix: LIBS += -lopencv_core -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -lopencv_videoio
...
macx:LIBS += -lvtkImagingCore-8.1 -lvtkIOCore-8.1 -lvtkIOImage-8.1 -lvtksys-8.1 -lvtkRenderingOpenGL2-8.1

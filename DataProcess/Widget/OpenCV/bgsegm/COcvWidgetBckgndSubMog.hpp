...
class COcvWidgetBckgndSubMog : public CWorkflowTaskWidget
{
    public:
        ...
        COcvWidgetBckgndSubMog(const std::shared_ptr<CWorkflowTaskParam>& pParam, QWidget *parent = Q_NULLPTR) : CWorkflowTaskWidget(parent)
        {
...
class COcvWidgetBckgndSubMogFactory : public CWidgetFactory
{
    public:
        ...
        {
            m_name = "ocv_bck_substractor_mog";
        }

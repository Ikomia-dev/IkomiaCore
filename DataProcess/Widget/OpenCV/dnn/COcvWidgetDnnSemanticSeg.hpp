...
#include "Process/OpenCV/dnn/COcvDnnSemanticSeg.h"
...
class COcvWidgetDnnSemanticSeg: public COcvWidgetDnnProcess
{
    public:
        ...
        {
            m_pParam = std::dynamic_pointer_cast<COcvDnnSemanticSegParam>(pParam);
            init();
        }
        ...
        {
            if(m_pParam == nullptr)
                m_pParam = std::make_shared<COcvDnnSemanticSegParam>();
...
class COcvWidgetDnnSegmentationFactory : public CWidgetFactory
{
    public:
        ...
        {
            m_name = "ocv_dnn_semantic_segmentation";
        }

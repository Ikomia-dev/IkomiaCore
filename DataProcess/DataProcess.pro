...
win32:CONFIG(release, debug|release): LIBS += -lopencv_features2d$${OPENCV_VERSION} -lopencv_imgcodecs$${OPENCV_VERSION}
...
win32:CONFIG(debug, debug|release): LIBS += -lopencv_features2d$${OPENCV_VERSION}d -lopencv_imgcodecs$${OPENCV_VERSION}d

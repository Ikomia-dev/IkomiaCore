...
class COcvDnnColorizationFactory : public CTaskFactory
{
    public:
        ...
        COcvDnnColorizationFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("This process gives the possibility to launch inference from already trained networks for colorization purpose (CAFFE, TENSORFLOW, DARKNET and TORCH)).").toStdString();

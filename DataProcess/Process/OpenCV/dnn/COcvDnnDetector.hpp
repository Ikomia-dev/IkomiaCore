...
class COcvDnnDetectorFactory : public CTaskFactory
{
    public:
        ...
        COcvDnnDetectorFactory()
        {
            m_info.m_name = "ocv_dnn_detection";
            m_info.m_shortDescription = QObject::tr("This process gives the possibility to launch inference from already trained networks for detection purpose (CAFFE, TENSORFLOW, DARKNET and TORCH)).").toStdString();

...
class COcvNiblackThresholdFactory : public CTaskFactory
{
    public:
        ...
        COcvNiblackThresholdFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("Performs thresholding on input images using Niblack's technique or some of the popular variations it inspired.").toStdString();

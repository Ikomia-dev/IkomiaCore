...
class COcvHoughLinesFactory : public CTaskFactory
{
    public:
        ...
        COcvHoughLinesFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function implements the standard or standard multi-scale Hough transform algorithm and the probabilistic Hough transform for line detection.").toStdString();

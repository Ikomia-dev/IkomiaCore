...
class COcvCannyFactory : public CTaskFactory
{
    public:
        ...
        COcvCannyFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function finds edges in the input image and marks them in the output map edges using the Canny algorithm. The smallest value between threshold1 and threshold2 is used for edge linking. The largest value is used to find initial segments of strong edges.").toStdString();

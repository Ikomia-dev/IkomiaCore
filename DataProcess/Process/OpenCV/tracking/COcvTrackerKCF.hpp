...
class COcvTrackerKCFFactory : public CTaskFactory
{
    public:
        ...
        COcvTrackerKCFFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("KCF is a novel tracking framework that utilizes properties of circulant matrix to enhance the processing speed.").toStdString();

...
class COcvGrayworldWBFactory : public CTaskFactory
{
    public:
        ...
        {
            m_info.m_name = "ocv_grayworld_wb";
            m_info.m_shortDescription = QObject::tr("This algorithm scales the values of pixels based on a gray-world assumption which states that the average of all channels should result in a gray image.").toStdString();

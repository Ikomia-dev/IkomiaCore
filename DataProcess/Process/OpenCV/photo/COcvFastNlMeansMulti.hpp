...
class COcvFastNlMeansMultiFactory : public CTaskFactory
{
    public:
        ...
        COcvFastNlMeansMultiFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("This process smoothes a video sequence with an edge-preserving filter (blur homogeneous area and keep borders intact).").toStdString();

...
class COcvIlluminationChangeFactory : public CTaskFactory
{
    public:
        ...
        COcvIlluminationChangeFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("Applying an appropriate non-linear transformation to the gradient field inside the selection and then integrating back with a Poisson solver, modifies locally the apparent illumination of an image.").toStdString();

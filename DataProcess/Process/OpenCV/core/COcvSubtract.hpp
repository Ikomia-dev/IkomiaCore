...
class COcvSubtractFactory : public CTaskFactory
{
    public:
        ...
        COcvSubtractFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function calculates the per-element difference of two arrays with the given formula:<br> <center><i>dst = saturate( src1 - src2 )</i></center>").toStdString();

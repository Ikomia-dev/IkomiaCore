...
class COcvAbsdiffFactory : public CTaskFactory
{
    public:
        ...
        COcvAbsdiffFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function calculates the per-element absolute difference between two arrays or between an array and a scalar with the given formula:<br> <center><i>dst = saturate( |src1 - src2| )</i></center>").toStdString();

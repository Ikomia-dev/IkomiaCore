...
class COcvInsertChannelFactory : public CTaskFactory
{
    public:
        ...
        COcvInsertChannelFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function inserts the given single channel(2nd input) into the source image (1st input). Index parameter is a 0-based index.").toStdString();

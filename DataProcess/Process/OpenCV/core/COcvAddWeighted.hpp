...
class COcvAddWeightedFactory : public CTaskFactory
{
    public:
        ...
        COcvAddWeightedFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function addWeighted calculates the weighted sum of two images with the given formula:<br> <center><i>dst = saturate( src1 * alpha + src2 * beta + gamma )</i></center>").toStdString();

...
class COcvCopyMakeBorderFactory : public CTaskFactory
{
    public:
        ...
        COcvCopyMakeBorderFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("The function copies the source image into the middle of the destination image. The areas to the left, to the right, above and below the copied source image will be filled with extrapolated pixels.").toStdString();

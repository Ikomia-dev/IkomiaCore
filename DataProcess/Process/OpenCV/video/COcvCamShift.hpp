...
class COcvCamShiftFactory : public CTaskFactory
{
    public:
        ...
        COcvCamShiftFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("This process computes object tracking using CamShift algorithm based on the back project of the histogram.").toStdString();

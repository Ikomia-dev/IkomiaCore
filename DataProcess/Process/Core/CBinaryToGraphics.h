...
class CBinaryToGraphicsFactory : public CTaskFactory
{
    public:
        ...
        CBinaryToGraphicsFactory()
        {
            ...
            m_info.m_shortDescription = QObject::tr("This process extract connected components from binary image and generates the corresponding graphics items.").toStdString();
